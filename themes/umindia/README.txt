ReadMe for the umindia directory
2014-08-07 (weiwang@umich.edu)

This folder contains a Zen sub-theme for Drupal 7 built for the umindia.org website.
This theme is built with the Zen Starter Kit sub theme, combined with the theme
from the mailman.columbia.edu site.

The rest of this document is originally from the Zen STARTERKIT theme.
